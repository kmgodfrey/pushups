...
summar: data summary
inference summary:t-test to compare means
...
Graphical summary shows line positions do less pushups than skilled players
...
This summary shows weight and height play a role in showing skill players do more pushups than line players
...
This t-test shows that there is a ability of position to perform pushups in 2 minutes 
...
the t-test to compare means, has a p-value of 0.000009421
This is less than 0.05, therefore we reject the null hypothesis, and conclude that we have evidence there is a difference in the average number of pushups that can be done in 2 minutes by line and skilled players.